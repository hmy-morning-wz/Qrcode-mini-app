...
var qr8BitByte = function(data) {
  ...
  for (var i = 0, l = _data.length; i < l; i++) {
    ...
    //console.log(_data.charAt(i)+"  "+(code))
    // if(code==48){
    //    byteArray[0]=0
    // }else if(code==49){
    //   byteArray[0] = 1
    ...
    //   byteArray[0] = 9
    // } else if (code == 97) {
    //   byteArray[0] = parseInt(10)
    // } else if (code == 98) {
    //   byteArray[0] = parseInt(11)
    // } else if (code == 99) {
    //   byteArray[0] = parseInt(12)
    // } else if (code == 100) {
    //   byteArray[0] = parseInt(13)
    // } else if (code == 101) {
    //   byteArray[0] = parseInt(14)
    // } else if (code = 102) {
    //   byteArray[0] = parseInt(15)
    // }
...
export const createQrCodeImg = function(text, options) {
  ...
  var errorCorrectLevel = options.errorCorrectLevel || 'L'
  var size = options.size || 500

  var qr

  try {
    qr = qrcode(typeNumber, errorCorrectLevel || 'L')
    qr.addData(text)
    qr.make()
  } catch (e) {
  //  console.log(e)
